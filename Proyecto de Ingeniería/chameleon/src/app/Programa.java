...
public class Programa {
	public static void main(String[] args) {
		...
		gf.EscribirUsuario(new administrador("admin", "admin", "Juan")); //para probar inciio sesion admin
		//gf.EscribirUsuario(new gerente("gerente", "gerente", "Jose")); //para probar inciio sesion gerente
		...
		*/
		...
		if (u instanceof administrador) {
			...
			boolean continuarEjecucion3 = true;
    		int opcionAdmin;
    		do {
        		...
        		switch (opcionAdmin) {
            		...
            		case 3:
						System.out.println("Saliendo del programa...");
                    	continuarEjecucion3 = false;
            		default:
                		System.out.println("Opción no válida. Intente de nuevo.");
                		break;
       				}
    			} while (opcionAdmin != 3 && continuarEjecucion3);
		...
		else if (u instanceof gerente) 
		{
			...
			boolean continuarEjecucion2 = true;
    		int opcionGerente;
    		do {
        		...
        		switch (opcionGerente) {
            		...
            		case 3:
						System.out.println("Saliendo del programa...");
                    	continuarEjecucion2 = false;
            		default:
                		System.out.println("Opción no válida. Intente de nuevo.");
                		break;
       				}
    			} while (opcionGerente != 3 && continuarEjecucion2);
